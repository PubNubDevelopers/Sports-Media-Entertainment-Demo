...
export default function Login() {
  ...
  return (
    <div className="flex w-screen lg:h-screen bg-gray-900 text-gray-200 p-8">
    ...
    <div className="lg:w-1/2 w-full mb-8 lg:mb-0">
      ...
      <div className="grid grid-cols-3 gap-6 mb-8 justify-center">
        {[
          ...
          <div
            key={avatarOption}
            className={`flex justify-center items-center rounded-full border-4 ${
              avatar === avatarOption ? "border-blue-500" : "border-transparent"
            } cursor-pointer`}
            style={{ width: "96px", height: "96px" }} // Uniform size for all avatars
